...
mrkpath = os.path.join(os.path.dirname(__file__), 'markers.txt')
markers = open(mrkpath)
str0 = markers.read()
# print(str0)
# print(os.path.dirname(__file__))

fcppath = os.path.join(os.path.dirname(__file__), 'import.fcpxml')
fcp = open(fcppath)
fcpx = fcp.read()
# print(fcpx)
...
expath = os.path.join(os.path.dirname(__file__), 'export.fcpxml')
# print(y)
